...
iptables -A FORWARD -i " . $network_setting['NetworkSetting']['wired_adapter_name'] . " -j ACCEPT
iptables -A FORWARD -i " . $network_setting['NetworkSetting']['wifi_adapter_name'] . " -m state --state ESTABLISHED,RELATED -j ACCEPT

# Packet masquerading
iptables -t nat -A POSTROUTING -o " . $network_setting['NetworkSetting']['wifi_adapter_name'] . " -j MASQUERADE ";
