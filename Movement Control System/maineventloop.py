...
# create threads
if isEncoderused:
    adcGetDataThread = threading.Thread(target=ADC.adcGetData,
                                        args=(adc0q, adc1q, adc2q, adc3q, adcGetDataFlag)).start()
    TickAdd_AvgDistanceThread = threading.Thread(target=ADC.TickAdd_AvgDistance, args=(
    distanceQ, adc0q, adc1q, adc2q, adc3q, TickAdd_AvgDistanceFlag)).start()
...
xypositionThread = threading.Thread(target=xyposition,
                                    args=(xcurrentQ, ycurrentQ, distanceQ, headingQ, xypositionFlag)).start()
